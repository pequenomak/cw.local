<?php
 ...
 $about_data = require_once('./data/about_data.php');
 $career_data = require_once('./data/career_data.php');
 $educations = getSortedArray($about_data['education']);
 $experiences = getSortedArray($career_data['experiences']);
?>
<!DOCTYPE html>
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                ...
                <h1 class="name"><?=$about_data['about']['name']?></h1>
                <h3 class="tagline"><?=$about_data['about']['post']?></h3>
            </div><!--//profile-container-->
            
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa fa-envelope"></i><a href="mailto:<?=$about_data['about']['email']?>"><?=$about_data['about']['email']?></a></li>
                    <li class="phone"><i class="fa fa-phone"></i><a href="tel:<?=$about_data['about']['phone']?>"><?=$about_data['about']['phone']?></a></li>
                    <li class="website"><i class="fa fa-globe"></i><a href="http://<?=$about_data['about']['site']?>" target="_blank"><?=$about_data['about']['site']?></a></li>
            ...
            <div class="languages-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    <? foreach ($about_data['languages'] as $language) { ?>
            ...
            <div class="interests-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    <? foreach ($about_data['interests'] as $interest) { ?>
                        <li><?=$interest?></li>
                    <? } ?>
                </ul>
            </div><!--//interests-->
        ...
        <div class="main-wrapper">
            ...
            <section class="section projects-section">
                ...
                <? foreach ($career_data['projects'] as $project) { ?>
                <div class="item">
            ...
            <section class="skills-section section">
                ...
                <div class="skillset">
                    <? foreach ($career_data['skills'] as $skill) { ?>
                    <div class="item">
